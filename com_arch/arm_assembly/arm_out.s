...
fib:
	...
	@ frame_needed = 1, uses_anonymous_args = 0
	push	{r4, r5, r7, r8, r9, lr} // save all value in register to stack, which automatically subtract from sp
	sub	sp, sp, #24 // allocate bytes or 6 address for stack
	add	r7, sp, #0 // making r7 storing the address of that
